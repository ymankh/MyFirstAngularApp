...
namespace MyFirstAngularApp.Server.Migrations
{
    ...
    [Migration("20241005173258_createSubsecriptionsTable")]
    partial class createSubsecriptionsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyFirstAngularApp.Server.Models.Subscription", b =>
                {
            ...
            modelBuilder.Entity("MyFirstAngularApp.Server.Models.Subscription", b =>
                {
                    b.HasOne("MyFirstAngularApp.Server.Models.CustomUser", "CustomUser")
                        .WithMany("Subscriptions")
                        .HasForeignKey("CustomUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyFirstAngularApp.Server.Models.SubService", "SubService")
                        .WithMany("Subscriptions")
